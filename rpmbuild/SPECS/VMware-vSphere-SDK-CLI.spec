...
BuildRequires: perl,perl-ExtUtils-MakeMaker,perl-URI,perl-XML-LibXML,perl-libwww-perl
BuildRequires: perl-Net-SSLeay,perl-Crypt-SSLeay,perl-SOAP-Lite,uuid-perl,perl-Class-MethodMaker
...
You can use the SDK to manage ESX 3.0.x, ESX/ESXi 3.5, ESX/ESXi 4.0, ESX/ESXi 4.1, ESXi 5.0, vCenter Server 2.5, vCenter Server 4.0, vCenter Server 4.1, vCenter Server 5.0 and vCenter Server 5.1.
